...
ActiveRecord::Schema.define(version: 20161109020304) do
  ...
  create_table "givers", force: :cascade do |t|
    ...
    t.index ["username"], name: "index_givers_on_username", unique: true, using: :btree
  end
  ...
  create_table "registrations", force: :cascade do |t|
    ...
    t.datetime "created_at",                 null: false
    t.datetime "updated_at",                 null: false
    t.integer  "pending_hours",  default: 0
    t.integer  "approved_hours", default: 0
  end
